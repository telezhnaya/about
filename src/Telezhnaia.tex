...
\begin{document}
    ...
    \name{\Huge Olga Telezhnaya\\[20pt]} % the \\[12pt] adds a blank line after name

    \address{April 2022 \\ Dubai, UAE}
...
%\noindent \textbf{MOOCs:} \href{https://stepik.org/certificate/c97c48eb77cd3edbf2b4cb8d1624930ffe87cb7c.pdf}{Algorithms and Data Structures} $\cdot$ \href{https://www.coursera.org/learn/machine-learning}{Machine Learning by Andrew Ng, Stanford} $\cdot$ \href{https://www.coursera.org/learn/matematika-dlya-vseh}{Mathematics for everyone by Aleksey Savvateev}
        ...
        \section{\uppercase{Working Experience} (5+ years total)}
% 0.5y of internships + 1.5y in Microsoft + 1y in Security Code + 1.5y in JetBrains
        \begin{spacing}{0.3}
            \textcolor[RGB]{220,220,220}{\rule{\linewidth}{0.4pt}}
        \end{spacing}
        ...
        \begin{tabular}{ll}
            ...
            & Rust, Python, SQL, Postgres, SingleStore \\
        \end{tabular}

        \begin{itemize} \itemsep -2pt
            \item Massively sped up the access to the NEAR blockchain data by making a full storage redesign and migrating to the columnar DB;
            \item Saved up to 400Gb of storage and increased the accuracy of data by changing the data format;
            \item Created end-to-end pipeline for supporting FT, NFT in wallets: from designing NEP standards (similar to ERC) to serving the data.
        \end{itemize}

        \begin{tabular}{ll}
            Aug 2019 -- Feb 2021 \quad & \textbf{\href{https://github.com/JetBrains/educational-plugin}{SWE at JetBrains}}, Educational Plugin \\
            & Kotlin, Java, git \\
        \end{tabular}
...
%   \item {\textbf{Senior SWE at Security Code}} (Python, PostgreSQL, SQLAlchemy, Marshmallow)~--- Developed backend for web client of security tool. Sped up transport component between core and Python backend by up to 200\% by replacing a self-written component with GRPC. Improved data validation component by using OpenAPI. (Sep 2018 – Aug 2019)
        ...
        \begin{itemize} \itemsep -2pt
            ...
            \item Contributed to product develomment teams and spoke about it at conferences.
        \end{itemize}
