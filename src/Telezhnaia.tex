...
\begin{document}
    ...
    \address{July 2025 \\ Porto, Portugal}
    ...
    \href{https://www.linkedin.com/in/telezhnaya/}{linkedin.com/in/telezhnaya}
    }
...
% 0.5y of internships + 1.5y at Microsoft + 1y at Security Code + 1.5y at JetBrains + 2y at Near
        ...
        \end{spacing}
         ...
         \begin{tabular}{ll}
            Mar 2021 -- Jan 2025 \qquad \qquad & \textbf{\href{https://near.org}{NEAR}}, Rust, Python, SQL, Postgres \\
        \end{tabular}
