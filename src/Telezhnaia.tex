...
\address{May 2020 \\ Saint Petersburg, Russia}
...
\vspace{0.2in}
   \begin{itemize} \itemsep -2pt  % reduce space between items
    \item \textbf{SWE at JetBrains}, Educational Products (Kotlin, Java, git)~--- Supported Go language in Educational plugin, improved integration with \href{https://stepik.org/}{Stepik} and \href{https://hyperskill.org}{JetBrains Academy}. (Aug 2019 – now)
   \item {\textbf{Senior SWE at Security Code}} (Python, Flask, RabbitMQ, PostgreSQL, SQLAlchemy, Marshmallow)~--- Developed backend for web client of security tool. Sped up transport component between core and Python backend by up to 200\% by replacing a self-written component with GRPC. Improved data validation component by using OpenAPI. (Sep 2018 – Aug 2019)
